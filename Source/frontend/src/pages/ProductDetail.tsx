...
import { Star, ShoppingBag, Heart, Share2, Truck, Shield, RotateCcw, ChevronLeft, ChevronRight, Check, Minus, Plus } from 'lucide-react';
...
const reviews = [
  {
    ...
    rating: 5,
    date: '15/12/2024',
    content: 'Sản phẩm tuyệt vời, giao hàng nhanh chóng. Rất hài lòng với chất lượng!',
  ...
  },
  {
    ...
    rating: 5,
    date: '10/12/2024',
    content: 'Máy đẹp, pin trâu, camera chụp ảnh rất đẹp. Recommend mọi người mua!',
  ...
  },
  {
    ...
    rating: 4,
    date: '05/12/2024',
    content: 'Sản phẩm chính hãng, đóng gói cẩn thận. Nhân viên tư vấn nhiệt tình.',
                  ...
                  {product.colors.map((color) => (
                    ...
                    >
                      {selectedColor === color.name && (
                        <Check className={cn(
                          'w-5 h-5',
                          color.hex === '#FFFFFF' || color.hex === '#F0F0EB' || color.hex === '#E3E4E5' || color.hex === '#F0E4D3'
                            ? 'text-foreground'
            ...
            {activeTab === 'description' && (
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed mt-4">
                  Sản phẩm {product.name} được thiết kế và sản xuất bởi Apple Inc. với các công nghệ tiên tiến nhất. 
                  Đây là sản phẩm chính hãng được phân phối tại Việt Nam bởi các đại lý ủy quyền của Apple.
                </p>
              </motion.div>
            )}
